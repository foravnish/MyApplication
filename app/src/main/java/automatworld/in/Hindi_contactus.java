 ...
 */
public class Hindi_contactus extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hindicontactus);
        context=this;
    ...
    private boolean isValidMail(String email2)
    {
        ...
        if(!check)
        {
            Toast.makeText(Hindi_contactus.this, "Not Valid Email", Toast.LENGTH_SHORT).show();
        }
        return check;
    }
    ...
    public void enquiry()
    {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Hindi_contactus.this, "Required Your Name", Toast.LENGTH_SHORT).show();
                }
                else if(!user_name.isEmpty() && company.isEmpty())
                {
                    Toast.makeText(Hindi_contactus.this, "Required Your Company name", Toast.LENGTH_SHORT).show();
                }
                else if(!user_name.isEmpty() && !company.isEmpty()&& ph.isEmpty())
                {
                    Toast.makeText(Hindi_contactus.this, "Required  Phone number", Toast.LENGTH_SHORT).show();

                }else if(!user_name.isEmpty() && !company.isEmpty()&& !ph.isEmpty() && !isValidMobile(ph))
                {
                    Toast.makeText(Hindi_contactus.this, "Enter valid phone number", Toast.LENGTH_SHORT).show();

                }

                else if(!user_name.isEmpty()&&!company.isEmpty()&&!ph.isEmpty()&& isValidMobile(ph) && email_id.isEmpty())
                {
                    Toast.makeText(Hindi_contactus.this, "Required Your Email", Toast.LENGTH_SHORT).show();

                }
                else if(!user_name.isEmpty() && !company.isEmpty()&& !ph.isEmpty() && isValidMobile(ph) && !isValidMail(email_id))
                {
                    Toast.makeText(Hindi_contactus.this, "Enter valid email id number", Toast.LENGTH_SHORT).show();

                }
                else if(!user_name.isEmpty()&&!company.isEmpty()&&!ph.isEmpty()&&!email_id.isEmpty() && isValidMail(email_id) &&message.isEmpty())
                {
                    Toast.makeText(Hindi_contactus.this, "Required Message", Toast.LENGTH_SHORT).show();
