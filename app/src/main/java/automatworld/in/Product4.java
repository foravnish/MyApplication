 ...
 */
public class Product4 extends Activity {
    ImageView back,home;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                InputStream in = null;
                OutputStream out = null;
                File file = new File(getFilesDir(), "Aqua Filtration & Fertigation Catalogue 2017.26-27.pdf");
                try
                {
                    in = assetManager.open("Aqua Filtration & Fertigation Catalogue 2017.26-27.pdf");
                    out = openFileOutput(file.getName(), Context.MODE_WORLD_READABLE);
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW);
                intent.setDataAndType(
                        Uri.parse("file://" + getFilesDir() + "/Aqua Filtration & Fertigation Catalogue 2017.26-27.pdf"),
                        "application/pdf");
        ...
        img8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                InputStream in = null;
                OutputStream out = null;
                File file = new File(getFilesDir(), "Aqua Filtration & Fertigation Catalogue 2017.28-29.pdf");
                try
                {
                    in = assetManager.open("Aqua Filtration & Fertigation Catalogue 2017.28-29.pdf");
                    out = openFileOutput(file.getName(), Context.MODE_WORLD_READABLE);
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW);
                intent.setDataAndType(
                        Uri.parse("file://" + getFilesDir() + "/Aqua Filtration & Fertigation Catalogue 2017.28-29.pdf"),
                        "application/pdf");
        ...
        img11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                InputStream in = null;
                OutputStream out = null;
                File file = new File(getFilesDir(), "Aqua Filtration & Fertigation Catalogue 2017.36-37.pdf");
                try
                {
                    in = assetManager.open("Aqua Filtration & Fertigation Catalogue 2017.36-37.pdf");
                    out = openFileOutput(file.getName(), Context.MODE_WORLD_READABLE);
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW);
                intent.setDataAndType(
                        Uri.parse("file://" + getFilesDir() + "/Aqua Filtration & Fertigation Catalogue 2017.36-37.pdf"),
                        "application/pdf");
